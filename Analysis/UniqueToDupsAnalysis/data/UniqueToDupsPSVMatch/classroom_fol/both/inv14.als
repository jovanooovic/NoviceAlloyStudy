...
-- div,1
all s: Student, c: Class, t: Teacher |t->c in Teaches and t->s in Tutors
-- div,2
...
-- div,1
all s: Student, c: Class, t: Teacher, g: Group | c->s->g in Groups => t->c in Teaches
-- div,1
...
-- div,2
all s: Student, c: Class, t: Teacher |t->c in Teaches and (t->s in Tutors or s->s in Tutors)
-- div,1
...
-- div,1
all s:Student,c:Class | (some g:Group | c->s->g in Groups) and (all t:Teacher | t->c in Teaches)
-- div,1
...
all s : Student | (some c : Class, g : Group | c->s->g in Groups) implies some t : Teacher | t->s in Tutors
-- div,4
all s:Student | some c:Class, g:Group | c->s->g in Groups => some t:Teacher | t->s in Teaches
-- div,1
...
-- div,1
all s: Student, c: Class, t: Teacher, g: Group | c->s->g in Groups => t->c in Teaches and t->s in Tutors
-- div,1
...
-- div,1
all p : Person | some c : Class, g : Group, t : Teacher | (c->p->g in Groups and t->c in Teaches) and t->p in Tutors
-- div,1
...
all s : Student, g : Group | some t : Teacher, c : Class | 
  		(c -> s -> g in Groups and t -> c in Teaches) and t -> s in Tutors
-- div,1
all p : Student | some c : Class, g : Group, t : Teacher | (c->p->g in Groups and t->c in Teaches) and t->p in Tutors
-- div,1
...
-- div,1
all s:Person,c:Class,g:Group | (c->s->g in Groups => some t:Person | t->c in Teaches and t->s in Tutors)
-- div,2
all p:Person,c:Class,t:Teacher | (all g:Group | c->p->g in Groups) and t->c in Teaches implies t->p in Tutors
-- div,1
all s:Person, t:Person | some c:Class, g:Group | c->s->g in Groups and t->c in Teaches => t->s in Tutors
-- div,1
...
-- div,3
all s: Student, c:Class, g:Group | (c->s->g in Groups => some t:Person | t->c in Teaches and t->s in Tutors)
-- div,1
all t : Teacher, p : Person | some c : Class, g : Group | t->p in Tutors implies (t->c in Teaches and c->p->g in Groups)
-- div,1
all s:Student, c:Class, t:Person |some g:Group | c->s->g in Groups implies t->c in Teaches implies t->s in Tutors
-- div,1
...
-- div,1
all s : Student, c : Class, g : Group | (c -> s -> g in Groups and all t : Teacher | t -> c in Teaches => t -> s in Tutors)
-- div,1
all s:Person,c:Class,g:Group | (c->s->g in Groups => some t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,3
all s:Person, t:Teacher | some c:Class, g:Group | c->s->g in Groups and t->c in Teaches => t->s in Tutors
-- div,1
all s:Student,c:Class,g:Group|some t:Teacher | t->c in Teaches and some s.(c.Groups) and some t.(c.Groups)
-- div,1
all s:Student, c:Class, t:Person |some g:Group | c->s->g in Groups implies t->c in Teaches and t->s in Tutors
-- div,1
all p : Person | some t : Teacher, c : Class, g : Group | t->p in Tutors implies t->c in Teaches and c->p->g in Groups
-- div,4
all s:Student,c:Class,g:Group | (c->s->g in Groups => all t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,3
all c:Class,s:Student,g:Group | c->s->g in Groups implies (all t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,1
all s : Student, c : Class, g : Group | some t : Teacher | 
...
-- div,1
all s : Student, c : Class, g : Group | c -> s -> g in Groups and some t : Teacher | t -> c in Teaches => t -> s in Tutors
-- div,2
...
-- div,6
all s:Student,c:Class, g:Group | (c->s->g in Groups and some t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,2
all s:Student,c:Class,g:Group | some t:Teacher | c->s->g in Groups and t->c in Teaches => t->s in Tutors
-- div,7
all s:Student, t:Teacher | some c:Class, g:Group | c->s->g in Groups and t->c in Teaches => t->s in Tutors
-- div,3
...
-- div,1
all s:Student | some c:Class,g:Group, t:Teacher | c->s->g in Groups and t->c in Teaches => t->s in Tutors
-- div,3
...
-- div,1
all p : Student | some c : Class, g : Group, t : Teacher | (c->p->g in Groups and t->c in Teaches) implies t->p in Tutors
-- div,1
all s : Student, g : Group | some t : Teacher, c : Class | 
  		c -> t -> g in Groups and t -> c in Teaches implies t -> s in Tutors
-- div,1
...
-- div,1
all s:Person,c:Class | (some g:Group | c->s->g in Groups) implies (some t:Person | t->c in Teaches and t->s in Tutors)
-- div,2
all p : Person, c : Class | some g : Group | c->p->g in Groups implies
...
-- div,1
all s:Person | some c:Class, g:Group | c -> s -> g in Groups implies (some t:Teacher | t -> c in Teaches and t -> s in Tutors)
-- div,1
all p:Person,t:Teacher | some c:Class | (some g:Group | c->p->g in Groups) and t->c in Teaches implies p->t in Tutors
-- div,1
all s:Student | some c:Class, g:Group | c -> s -> g in Groups implies (some t:Person | t -> c in Teaches and t -> s in Tutors)
-- div,1
all t : Teacher | some c : Class, s : Person | t->c in Teaches and (some g : Group | c->s->g in Groups) implies t->s in Tutors
-- div,1
all s:Student,c:Class| (some g:Group | c->s->g in Groups) and (all t:Teacher | t->c in Teaches implies t->s in Tutors)
-- div,1
no p:Person | (some c:Class,g:Group | c->p->g in Groups and (some t:Teacher | t->c in Teaches and p->t not in Tutors))
-- div,1
all s:Person | some c:Class,g:Group | (c->s->g in Groups and some t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,2
all s:Student,c:Class | (some g:Group | c->s->g in Groups) implies some t:Person | t->c in Teaches and t->s in Tutors
-- div,1
...
-- div,3
all s:Person,c:Class | (some g:Group | c->s->g in Groups) implies (some t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,2
...
-- div,1
all s: Student, c:Class | some g:Group | (c->s->g in Groups => some t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,1
all s:Student,c:Class | (some g:Group | c->s->g in Groups) implies some t:Teacher | t->c in Teaches and t->s in Tutors
-- div,6
all p:Student,t:Teacher | some c:Class | (some g:Group | c->p->g in Groups) and t->c in Teaches implies t->p in Tutors
-- div,1
...
-- div,2
all s:Student | some c:Class,g:Group | (c->s->g in Groups and some t:Teacher | t->c in Teaches and t->s in Tutors)
-- div,6
all s : Student | some t : Teacher | (some c : Class, g : Group | 
  		c -> t -> g in Groups and t -> c in Teaches) and t -> s in Tutors
-- div,1
...
-- div,1
all s:Person | some c:Class | (some g:Group | c -> s -> g in Groups) implies (all t:Person | t -> c in Teaches implies t -> s in Tutors)
-- div,1
...
-- div,1
all s:Person | some c:Class |(some g:Group | c -> s -> g in Groups) implies (some t:Person | t -> c in Teaches and t -> s in Tutors)
-- div,1
all x : Person | some y : Class | (some z : Group | y->x->z in Groups) implies all u : Teacher | u->y in Teaches and u->x in Tutors
-- div,1
all s : Student | all t : Teacher | (all c : Class | (some g : Group | c->s->g in Groups) and t->c in Teaches) => t->s in Tutors
-- div,1
...
-- div,1
all s : Person | some t : Teacher | (some c : Class | (some g : Group | c->s->g in Groups) and t->c in Teaches) => t->s in Tutors
-- div,1
...
-- div,1
all s : Student | some t : Teacher | some c : Class | (some g : Group | c->s->g in Groups) and t->c in Teaches => t->s in Tutors
-- div,1
all s : Student | some t : Teacher | (some c : Class | (some g : Group | c->s->g in Groups) and t->c in Teaches) => t->s in Tutors
-- div,2
...
-- div,1
all s : Student | some t : Teacher | some c : Class | some g : Group | c->s->g in Groups and t->c in Teaches => t->s in Teaches
-- div,1
