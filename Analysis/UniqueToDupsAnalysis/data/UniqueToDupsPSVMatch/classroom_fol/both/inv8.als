...
-- div,10
all t1, t2 : Teacher | all c : Class | not (t1 != t2 and (t1->c in Teaches and t2->c in Teaches))
-- div,1
some t:Teacher | some c1,c2:Class | t->c1 in Teaches and t->c2 in Teaches implies c1=c2
-- div,1
all t1, t2 : Teacher | some c : Class | not (t1 != t2 and (t1->c in Teaches and t2->c in Teaches))
-- div,1
all t1,t2:Teacher | some c1:Class | t1->c1 in Teaches and t2->c1 in Teaches implies t1=t2
-- div,1
all c1, c2 : Class | some p : Person | p in Teacher and p -> c1 in Teaches => p -> c2 in Teaches
-- div,1
...
-- div,1
all c1, c2 : Class | some p : Person | p in Teacher and (p -> c1 in Teaches && p -> c2 in Teaches) => c1 = c2
-- div,1
