all s: Student, c: Course | s.projects
-- div,1
all disj s1,s2:Student, c:Course, p:Project | s1.grades
-- div,1
all disj s1,s2:Student, c:Course, p:Project | grades.s1
-- div,1
all disj s1,s2:Student, c:Course, p:Project | s1.(Course.grades)
-- div,2
all p : Project, g,h : (projects.p).grades.(projects.p) | g in (h + prev[h] + next[h])
-- div,1
all s, s1 : Student, p : s.projects & s1.projects | one s.((Course <: projects).p).grades
-- div,1
all disj s, s1 : Student, p : s.projects & s1.projects | s.((Course <: projects).p).grades
-- div,3
all disj s, s1 : Student, p : s.projects & s1.projects | one s.(projects.p <: Course).grades
-- div,1
all disj s, s1 : Person, p : s.projects & s1.projects | one s.((Course <: projects).p).grades
-- div,1
all disj s, s1 : Student, p : s.projects & s1.projects | one s.((Course <: projects).p).grades
-- div,5
all disj s, s1 : Student, p : s.projects & s1.projects | some s.((Course <: projects).p).grades
-- div,1
all disj s, s1 : Student, p : s.projects & s1.projects | one (s.((Course <: projects).p)).grades
-- div,1
all c:Course,p:c.projects,disj s1,s2:projects.p | s1.(c.grades) in s2.(c.grades).(iden+next+prev)
-- div,1
all c : Course, p : c.projects, s1, s2 : Person<:projects.p | s1->s2 in (prev+iden+next).(c.grades)
-- div,1
all p : Project , g,g1 : (Course :>projects.p).grades.~Person |  g = g1 or g1=prev[g] or g=prev[g1]
-- div,1
all disj s, s1 : Student | all p : s.projects & s1.projects | one s.((Course <: projects).p).grades
-- div,1
...
all disj s1,s2:Student, c:Course, p:Project | 
  		...
  		s1.(c.grades)
-- div,1
all c : Course, p : c.projects, s1, s2 : Person<:projects.p | s1.(c.grades)->s2.(c.grades) in (prev+iden+next).(c.grades)
-- div,1
all disj s, s1 : Student, p : s.projects & s1.projects | s.((Course <: projects).p).grades = next[s.((Course <: projects).p).grades]
-- div,1
all disj s, s1 : Student | all p : s.projects & s1.projects | s1.(Course <: projects).p.grades  next[s.(Course <: projects).p.grades]
-- div,1
all s,s1 : Student , p : (s.projects & s1.projects) , g :s.((Course :>projects.p).grades) , g1: ((Course :>projects.p).grades) | g = g1
-- div,2
all c: Course, p: Project, s1,s2: Student | p in c.projects&s1.projects&s2.projects implies s2 in s1.grades.next or s1 in s2.grades.next
-- div,1
all c : Course, disj s1, s2 : Student | c in (s1.enrolled & s2.enrolled) and (c.grades.s1 > c.grades.s2 + 1 or c.grades.s1 < c.grades.s2 - 1)
-- div,1
all c: Course, g1, g2: Grade, p: Project, disj s1, s2:Student | s1->p+s2->p in projects && c->s1->g1+c->s2->g2 in grades => not smaller[g1,g2]
-- div,1
...
-- div,1
all p : Project, s : (Student <: projects.p) | let gs = (projects.p).grades.Student| let g = C.grades[s] | g = gs or g = prev[gs] or prev[g] = gs
-- div,1
...
-- div,1
all c: Course, s1: Student, s2: Student - s1 | ((s1.enrolled in c) and (s2.enrolled in c) and lone (s1.projects & s2.projects)) implies c.grades.s1
-- div,1
all p : Project, s : (Student <: projects.p) | let gs = (projects.p).grades.Student| let g = C.grades[s] |
  		g = gs or g = prev[gs] or prev[g] = gs
-- div,1
all c:Course,p:Project,disj s1,s2:Person |  s2->c in (Person<:projects) and some s2.(c.grades) implies s1.(c.grades) in s2.(c.grades).(iden+next+prev)
-- div,1
all c: Course, p: Project, s1,s2: Student | p in c.projects and p in s1.projects and p ins2.projects implies s2 in s1.grades.next or s1 in s2.grades.next
-- div,1
all c: Course, p: Project, s1,s2: Student | p in c.projects and p in s1.projects and p in s2.projects implies s2 in s1.grades.next or s1 in s2.grades.next
-- div,1
...
-- div,2
all disj s1, s2 : Student | all c : (s1.projects & s2.projects).~projects | s1.(c.grades) in s2.1.(c.grades) + next[s2.1.(c.grades)] + prev[s2.1.(c.grades)]
-- div,1
all c: Project, g1, g2: Grade, p: Project, disj s1, s2:Student | s1->p+s2->p in projects && c->s1->g1+c->s2->g2 in grades => not smaller[g1,g2] && not larger[g1,g2]
-- div,2
...
all disj s1, s2 : Student | all c : (s1.projects & s2.projects).~(Student <: projects) | s1.(c.grades) in (s2.1.(c.grades) + next[s2.1.(c.grades)] + prev[s2.1.(c.grades)])
-- div,1
all disj s1, s2 : Student | some s1.projects & s2.projects implies all p : projects & s2.projects | projects.p.s1 in projects.p.s2 + next[projects.p.s2] + prev[projects.p.s2]
-- div,1
...
-- div,1
all c:Course,p:Project,disj s1,s2:Person | c->p in projects and s1->c in projects and s2->c in projects and some s2.(c.grades) implies s1.(c.grades) in s2.(c.grades).(iden+next+prev)
-- div,1
all c: Course, s1: Student, s2: Student - s1 | ((s1.enrolled in c) and (s2.enrolled in c) and lone (s1.projects & s2.projects)) implies ((prev[grades.s2] + next[grades.s2] + grades.s2))
-- div,1
...
-- div,1
all c:Course,p:Project,disj s1,s2:Person | c->p in projects and s1->c in Person<:projects and s2->c in Person<:projects and some s2.(c.grades) implies s1.(c.grades) in s2.(c.grades).(iden+next+prev)
-- div,1
...
all disj s1,s2:Student, c:Course, p:Project | 
          ...
          or 
  		  s2.(c.grades) - s1.(c.grades) <=1
-- div,1
all c:Course,p:Project,disj s1,s2:Person | c->p in (Course<:projects) and s1->p in (projects) and s2->c in (Person<:projects) and some s2.(c.grades) implies s1.(c.grades) in s2.(c.grades).(iden+next+prev)
-- div,1
...
-- div,2
all s1,s2:Student, p:Project, c:Course, g1,g2:Grade | (s1!=s2 and p in s1.projects and p in s2.projects and p in c.projects) implies (g1 in s1.grades and g2 in s2.grades implies (g1=prev[g2] or g2=prev[g1]))
-- div,2
all c:Course,p:Project,disj s1,s2:Person | c->p in Course<:projects and s1->c in (Person<:projects) and s2->c in Person<:projects and some s2.(c.grades) implies s1.(c.grades) in s2.(c.grades).(iden+next+prev)
-- div,1
...
-- div,1
all c: Course, s1: Student, s2: Student - s1 | (s1.enrolled in c) and (s2.enrolled in c) and lone (s1.projects & s2.projects) implies (grades.s1 = grades.s2 + 1 or grades.s1 = grades.s2 - 1 or grades.s1 = grades.s2)
-- div,1
...
-- div,1
all p : Project | all s1,s2 : Student | all c : Course |s1!=s2 and p in s1.projects and p in s2.projects and p in c.projects implies (all g1, g2 : Grade | g1 in s1.c.grades and g2 in s2.c.grades implies (g1 = prev[g2] or g2 = prev[1] or g1=g2))
-- div,1
all p : Project |  all c : Course | all s1,s2 : Student | (1 != s2 and p in s1.projects and p in s2.projects and p in c.projects) implies all g1, g2 : Grade | g1 in s1.c.grades and g2 in s2.c.grades implies (g1=prev[g2] or g2=prev[g1] or g1=g2)
-- div,1
