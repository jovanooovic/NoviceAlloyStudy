all c: Course, p: Project, s1: Student, s2: Student| p in s1.projects && p in s2.projects => (s1 -> c.grades) = (s2 -> c.grades)
-- div,1
all disj s1,s2 : Student | all c : Course | all p: c.projects | p in s1.projects and p in s2.projects => s1.(c.grades) = s2.(c.grades)
-- div,1
all c: Course, p: Project, s1: Student, s2: Student, g: Grade | p in s1.projects && p in s2.projects => (s1 -> c.grades) = (s2 -> c.grades)
-- div,1
all disj s1,s2 : Student | all c : Course | some p: Project | p in s1.projects and p in s2.projects => s1.((projects.p).grades) = s2.((projects.p).grades)
-- div,1
all disj s1, s2 : Student |
  		all g1 : s1.(Course.grades) |
  			all g2 : s2.(Course.grades) |
  				some (s1.projects & s2.projects) implies (g2 in g1.prev or g1 in g2.prev)
-- div,1
all disj s1,s2 : Student | all c : Course | all p: c.projects | p in s1.projects and p in s2.projects => (s1.(c.grades) = s2.(c.grades) + 1) or (s1.(c.grades) = s2.(c.grades) - 1)
-- div,2
all disj s1, s2 : Student |
  		all g1 : s1.(Course.grades) |
  			all g2 : s2.(Course.grades) |
  				some (s1.projects & s2.projects) implies (g2 in g1.prev or g1 in g2.prev or g1 = g2)
-- div,1
...
all disj s1, s2 : Student |
  		all g1 : s1.(Course.grades) |
  			all g2 : s2.(Course.grades) |
  				(some (s1.projects & s2.projects) and some g1 and some g2 )implies (g2 in g1.prev or g1 in g2.prev or g1 = g2)
-- div,1
...
-- div,1
all s1:Student, s2:Student, c:Course, p:Project| (s1!=s2 and p in s1.projects and p in s2.projects and p in c.projects) implies ( all g1,g2:Grade | g1 in s1.(c.grades) and g2 in s2.(c.grades) implies (g1=prev[g2] or g2 = prev[g1] or g1=g2) )
-- div,1
