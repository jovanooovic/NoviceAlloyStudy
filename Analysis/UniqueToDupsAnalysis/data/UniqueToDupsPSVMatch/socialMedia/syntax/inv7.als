...
all u1, u2, u3 : User
-- div,2
all s : User.suggested |
-- div,1
all u, s: User | u in u.follow
-- div,1
all dist u1: User | u1 in User
-- div,1
all u:User | u.suggested in u.^(follows).
-- div,1
all u1, u2:User | u1->u2 in follows => ()
-- div,2
all x : User | x.suggeste not in x.follows
-- div,1
all u1, u2, u3 : User | u2 in u1.follows im
-- div,1
all u: Users| u.suggested in u.follows.follows
-- div,1
User:u | User-u & not u.follows in u.suggested
-- div,1
User:u | User-u & not u.follows in suggested.u
-- div,1
all u : User | all u.follows.follows & u.follows
-- div,1
all u : User | u.suggested in u.followed.followed
-- div,1
all u : User | suggested = one (u.follows).follows
-- div,1
all u : User | no (u.suggested & u.follows) and ...
-- div,7
all u:User | s: u.suggested | s in u.follows.follows
-- div,1
User:u | u.suggested = u.follows.follows - u.follows
-- div,1
all u:User | sugested = u.follows.follows - u.follows
-- div,1
all u : Users | u.suggested = (u.follows).follows - u
-- div,1
all u: User | s: u.suggested | s in u.follows.follows
-- div,1
all x: User | x.suggested in x->y.follows - x.follows
-- div,1
all u : User | u.suggested in u.follows.(follows - id)
-- div,1
all u : User| set s in u.sugested | u not in follows.s
-- div,1
all x : User | x.follows not in x.suggested
-- div,1
User:u | u.suggested = u.follows.follows - u.follows -u
-- div,1
all u : User| set s in u.suggested | u not in follows.s
-- div,1
all u : User| all s in u.suggested | u not in follows.s
-- div,1
all u1 | u1.suggested in u1.follows.follows - u1.follows
-- div,1
all u:Users| u.suggested = u.follows.follows - u.follows
-- div,1
all: x:User | x.suggested-x.follows in x.follows.follows
-- div,1
all u:User | u.suggested = (a.follows.follows -a.follows)
-- div,1
all u : User | all sug : u.sug | sug in u.follows.follows
-- div,1
all u:User = u.suggested = (u.follows.follows - u.follows)
-- div,2
all u : User | u.sugested in u.follows.follows - u.follows
-- div,1
all u : user | u.suggested = u.follows.follows - u.follows
-- div,1
all u:User| u:suggested = u.follows.follows - u.follows - u
-- div,1
disj u,s:User | s in u.suggested iff s in u.follows.follows
-- div,1
all u:Users| u.suggested = u.follows.follows - u.follows - u
-- div,6
all u1,u2 | u2 in u1.suggested implies not(u2 in u1.follows)
-- div,1
all x:User | u.suggested = u.follows.follows - u.follows - u
-- div,1
all u: User | u.suggested = u.followed.followed - u.followed
-- div,1
all u : User | u.suggested in u.followed.followed - u.follows
-- div,1
all u:User | u1.suggested = u.follows.follows - u.follows - u
-- div,1
all u : User | u.suggested = u.follows.follows - u  u.follows
-- div,1
all x, z : User | x in suggested.z iff x != z
-- div,1
...
all u : User | u.Suggested = u.follows.follows - u.follows - u
-- div,1
all x : User | y in x.suggested implies y in x.follows.follows
-- div,1
...
all u: User| u.suggested = (u.follows.follows - ( u.follows +u)
-- div,1
all u,s:User | s in u1.suggested implies s in u.follows.follows
-- div,1
all u : User | u.sugested in u.follows.User.follows - u.follows
-- div,1
disj u,s:User | s in u.suggested implies s in u.follows.follows
-- div,1
all x : User | x.suggested = (x.follows.follows - x.follows + u)
-- div,1
...
all x : User | u.suggested = (u.follows.follows - u.follows - u)
-- div,1
all u : User | all sug : u.suggestions | sug in u.follows.follows
-- div,1
all u: User| u.suggested in u.follows.follows and not in u.follows
-- div,1
all s, u : User, | s in u.suggested implies s in u.follows.follows
-- div,1
all u: User | u.suggested in u.follows.follows && not in u.follows
-- div,1
all u: User | u.suggested not in u.follows && in u.follows.follows
-- div,1
all x : User | suggest.x in ( follows.follows.x and not follows.x)
-- div,1
all u: User| u.suggested in (u.follows.follows && not in u.follows)
-- div,1
...
+
-- div,3
no x, y : User | x in y.follows => y in not x.suggested + x.follows
-- div,1
all u: User | u.suggested not in u.follows and in u.follows.follows
-- div,1
all u : User | u.suggested = (u.follows.follows - (u.follows + u)))
-- div,1
all u: User | u.follows.follows in u.suggested and not in u.follows
-- div,1
all u : User | u.suggested in u.follows.follows and not in u.follows
-- div,1
all u: User | u.suggested in u.follows.follows and  not in u.follows
-- div,1
all u:User | u.suggested not in u.follows |  u.suggested in u.follows
-- div,2
all x : User | (x.suggested in (x.follows.follows & not in x.follows)
-- div,1
all disj u : User | u.suggesqted in u.follows.follows - u.follows - u
-- div,1
all u : User | suggested =  (u -> ((u.follows).follows - (u.follows))
-- div,1
all u: User | u.suggested = {u' : u' in u.follows.follows - u.follows}
-- div,1
all x : User | x.suggested in (x.follows.follows and not in x.follows)
-- div,3
all u : User | u.suggested in u.follows.follows - u.follows - u u.sees
-- div,1
all s, u : User | u->s in sugested => (some f : User | u->f in follows)
-- div,1
all u : User , p : User-x | p in u.suggested iff p in x.follows.follows
-- div,1
all u : User , p : User-x | p in u.suggested iff p in u.follows.follows
-- div,1
all u: User | all f : u.sugested | u in f implies u in u.follows.follows
-- div,1
...
-- div,1
all u: User | s: u.suggested | s not in u.follows and s in u.follows.follows
-- div,1
all u : User | u.suggested in u.^follows and and u.suggested not in u.follows
-- div,1
all u:User | u.suggested not in u.follows |  u.suggested in u.follows.follows
-- div,4
all u : User | u.suggested in  u.follows.follows |  u.suggested  in u.follows
-- div,1
all x : User | suggested.x in follows.follows.x and suggested.x not follows.x)
-- div,1
all u : User, sugg in u.suggested | u not in sugg && u.follows.follows in sugg
-- div,1
all u : User| u.suggested in  u.follows.follows |  u.suggested not in u.follows
-- div,3
all u : User | u.suggested not in u.follows and u.suggsted in u.follows.follows
-- div,1
all: x:User | x.suggested in x.follows.follows and x.suggested not in x.follows
-- div,1
all u : User |all s : u.suggested| s in  u.follows.follows | s not in u.follows
-- div,1
all u1, u2 : User | u1 in suggested.u2 => u1 in ^follows.u2
-- div,1
all u : User | u.suggested in  u.follows.follows |  u.suggested not in u.follows
-- div,1
all x : User | x.suggested implies (x in x.follows.follows and not in x.follows)
-- div,1
all e: User, o: User - e, s: User - (e + o) | s in o.follows => s in u.suggested
-- div,1
all u, x : User | all s: u.follows | x in u.suggested implies x in s.follows and
-- div,1
all u,u1,u2:User | u1 in suggested.u implies u1 in u2follows and u2 in follows.u
-- div,1
all u: User | u.suggested in u.follows.follows-u.follows
-- div,3
all disj e: User, o: User | (e in s && s in o && e not in o) => e in o.suggested
-- div,1
all e: User, o: User - u, s: User - (e + o) | s in o.follows => s in u.suggested
-- div,1
all x: User | all f : u.follows.follows | f not in x.follows => f  in x.suggested
-- div,1
| all s: u.suggested | some f: u.follows  | s in f.follows and s not in u.follows
-- div,1
all user : User | user in user.suggested => user.follows.follows != user.folowers
-- div,1
all x : User | (x.suggested in x.follows.follows) & no (x.suggested in x.follows)
-- div,1
all u1,u2 : User | u2 in u1.suggested <=> and u2!=u1 and u2 in u1.follows.follows
-- div,1
all u: User | u.suggested in u.follows.follows and u.suggested not in u.follows
}
-- div,1
all u1:User | some u2:User | u1 -> u2 not in follows imples u1 -> u2 in suggested
-- div,1
all u: User| u.seggested in u.follows.follows - u => u.suggested not in u.follows
-- div,1
all a,b : User | a in b.follows.follows && a not in b.follows <-> a in b.suggested
-- div,1
all u: User | u.suggested in u.follows.follows - u.follows & no u.suggested & iden
-- div,1
all x,y : User | iff y in x.follows and x not in y.follows implies x in y.sugested
-- div,1
all u: User | all u1: u.follows | all u.suggested not in u1.follows - u.follows - u
-- div,1
all u: User |
all u2 in (u.follows.follows - u.follows - {u}) | u2 in (u.suggested)
-- div,1
all x : User | all u : x.follows.follows| u in x.suggested if u not in x + x.follows
-- div,1
all x,y : User | iff (y in x.follows and x not in y.follows) implies x in y.sugested
-- div,2
all u: User |
all v: User |
v in u.suggested if
(v in (follows.follows) - u.follows)
-- div,1
all u : user | all s : u.suggested | (s not in u.follows) and s in u.follows.follows
-- div,1
all disj u,s:User | s in u.suggested implies s in u.follows.follows
-- div,1
all x,y : User | iff (y in x.follows and x not in y.follows) implies x in y.suggested
-- div,1
...
-- div,4
all x, y:User | x in y.suggested implies x not in y.follows and x in y.folows.follows
-- div,1
all u, s : User | s in u.suggested iff (s in u.follows.follows and s not in u.follows
-- div,1
all u : User | all s : u.suggested | (s not u.follows) and (s in (u.follows).follows)
-- div,1
...
-- div,1
all x1, x2 | x2 & x1.suggested implies x2 & x1.follows.follows and x2 not in x1.follows
-- div,1
all u : User| all s in u.suggested | u not in follows.s and some follows.u in follows.s
-- div,1
all u,y : User | x in suggested.y implies y in u.follows.follows and y not in u.follows
-- div,1
all u1,u2,u3 : Users | u3 in u1.suggested implies u3 in u2.follows and u2 in u1.follows
-- div,1
all u : User| set s in u.suggested | u not in follows.s and some follows.u in follows.s
-- div,1
all disj u,uu: User| u in uu.follows.follows and not in uu.follows => u in uu.suggested
-- div,1
...
-- div,2
all u1, u2 : User | u2 in u1.suggested => u2 in u.follows.follows and u2 not in u.follows
-- div,1
all u1, u2 : User | (u1 not in follows.u2 and u2 in u1^follows) implies u2 in u1.suggested
-- div,2
all disj u1, u2 : User | u2 in u1.follows.follows => u2 in u1.suggested
-- div,2
all x : User | all s : x.suggested | s in x.follows.follows and s not in x.follows and x!=y
-- div,3
all u : User | all s : u.suggested D| all f : u.follows | (s not in f) and (s in f.follows)
-- div,1
...
-- div,1
all u : User, p : User - u | p in u.suggested | p in u.follows.follows and p not in u.follows
-- div,1
all u1 : User | all u2: u1.follow.follow | u2 not in u1.follows implies (u2 in u1.suggested )
-- div,1
all u1, u2 : User | u2 in u1.suggested implies u2 not in u.follows && u2 in u.follows.follows
-- div,1
all u1, u2 : User | u2 in u1.suggested implies u2 not in u1.follows && u2 in u.follows.follows
-- div,1
...
-- div,1
all disj u1,u2 : User | (u2 in u1.follows.follows && u2 not in u1.follows) => u2 in u.suggested
-- div,1
...
-- div,1
all e: User - (o + s), o: User - (e + s), s: User - (e + o) | s in o.follows => s in e.suggested
-- div,3
all u: User | u in User.suggesteds implies (u not in User.follows and u in User.follows.follows)
-- div,1
all u : User , p : User-u | p in u.suggested implies (p in u.follows.follows p not in u.follows)
-- div,1
all e: User, o - (o + s): User - (e + s), s: User - (e + o) | s in o.follows => s in e.suggested
-- div,1
all u1,u3 | u1->u3 in suggested implies (some u2:User | u1->u2 in follows and u2->u3 in follows)
-- div,1
...
-- div,1
all u1, u2: User | u2 in u1.suggested implies (u2 in u1.follows.follows and u2 not in u1.followa)
-- div,1
...
-- div,1
all u1,u2 : User | u2 in u1.suggested implies (u2 not in u1.followed and u2 in u1.follows.follows)
-- div,1
...
-- div,1
all u : User | all s : u.suggested D| all f : u.follows | (s not in u.follows) and (s in f.follows)
-- div,1
all u : User | all others : followed.u.followed | others not in followed.u => others in suggested.u
-- div,1
all u, y, z : User | u in y.follows and y in z.follows implies z in u.suggested| z not in u.follows
-- div,1
disj all u,s : User | s in u.suggested iff (s in u.follows.follows and s not in u.follows and u!=s)
-- div,1
disj all u,s : User | s in u.suggested iff( s in u.follows.follows and s not in u.follows and u=!s)
-- div,1
all x : User | all y : x.suggested | (y not in z.follws+x) and (some z: x.follows | y in z.follows)
-- div,1
all u, f, s: User | (f in u.follow and s in f.follow and s not in u.follow) implies s in u.suggested
-- div,1
...
all u, y, z : User | (u in y.follows and y in z.follows) implies z in u.suggested | z not in u.follows
-- div,2
all u : User | u.suggested in ((u.follows).follows) and no u.suggested&u and no u.suggeste&(u.follows)
-- div,1
all u1, u2 : User | u1 != u2 | u2 in u1.suggested => u2 in u1.follows.follows and u2 not in u1.follows
-- div,1
...
-- div,1
u1,u2,u3:User| u3 in u1.suggested implies u3 in u2.follows and u2 in u1.follows and u3 not in u1.follows
-- div,2
...
-- div,1
all u1, u2: User | u2 in u.suggested implies u2 in u1.follows.follows && u2 != u1 && u2 not in u1.follows
-- div,1
...
-- div,1
u1, u2, u3: User | u3 in u2.suggest and u3 in u1.follows implies u1 in u2.follows and u3 not in u2.follows
-- div,2
all u : User | all s : u.suggested | some ufoll : u.followed | s not in u.followed and s in ufoll.followed
-- div,1
All u1,u2 : User | u2 in u1.suggested <=> (u1 != u2 and u2 not in u1.follows and u2 in u1.follows.follows)
-- div,2
all u, y, z : User | (y : u.follows and z in y.follows and z not in u.follows) implies z in 			u.suggested
...
all u1, u2 : User | u2 in u.suggested implies u2 in u1.follows.follows && u2 != u1 && u2 not in u1.follows
-- div,1
all u1,u2,u3:User | (u1->u2 in follows  and u2->u3 in follows u1->u3 not in follows) => u1->u3 in suggested
-- div,1
all u1,u2 : User | u1 != u2 and u2 in u1.suggested implies u2 no in u1.follows and u2 in u1.follows.follows
-- div,1
all u : Users | all s : u.suggested | some ufoll : u.followed | s not in u.followed and s in ufoll.followed
-- div,1
all u1:User, u2:User, u3:User | u3 in u1.suggested implies (u3 not in u.follows and u3 in u.follows.follows)
-- div,1
all u : Users | all s : u.suggested | s not in u.followed and some ufoll in u.followed | s in ufoll.followed
-- div,2
all u1,u2 : User | u2 in u1.suggested implies (u1!=u2 and u2 in u1.follows.suggest and u2 not in u1.follows)
-- div,1
all u : Users | all s : u.suggested | some ufoll in u.followed | s not in u.followed and s in ufoll.followed
-- div,2
all u1, u2: User | u2 in u.suggested implies (u2 in u1.follows.follows and u1 != u2 and u2 not in u1.follows)
-- div,1
all u1, u2, u3 : User | u3 in u1.suggested => u3 not in u1.follows and u3 in u2.follows and u2 in u1.folllows
-- div,1
all x0,x1:User | x1 in x0.suggested implies some x3:User x1 not in x0.follows and x0!=x1 and x1 in x3.follows
-- div,2
all u1,u2,u3:Users | u3 in u1.suggested and u2 in u1.follows and u3 in u2.follows implies u3 not in u1.follows
-- div,1
All u1,u2 : User | u2 in u1.suggested <=> (u1 != u2 and u2 not in u1.follows and u2 not in u1.follows.follows)
-- div,1
all u : User | all u2 : User - u.follows |
...
-- div,1
all u1, u2, u3 | (u1->u2 in follows and u2->u3 in follows and u1->u3 not in follows)
<=> (u1->u3 in suggested)
-- div,1
all u : Users | all s : u.suggested | s not in u.followed and (some ufoll in u.followed | s in ufoll.followed)
-- div,1
all u1 : User, u2: User | u2 in u.suggested implies u2 in u1.follows.follows && u2 != u1 && u2 not in u1.follows
-- div,1
...
-- div,1
all u1, u2, u3 : Users | u1 -> u2 in follows and u2 -> u3 follows and u1 -> u3 not in follows => u1 -> u3 in sees
-- div,1
all x : User | all suggested.x not in follows.x and all suggested.x in follows.follows.x and x not in suggested.x
-- div,1
all u1, u2 : User - Influencer | u2 in u1.suggested implies and u2 in u1.follows.follows and u2 not in u1.follows
-- div,1
...
-- div,2
all user1, user2, user3 : User | user2 in user1.follows and user3 in user2.follows implied user3 in user1.suggested
-- div,1
all usr1,usr2 : User | usr1->usr2 in follows some usr3:User | usr2->usr3 in follows implies usr1->usr3 in suggested
-- div,2
...
-- div,4
all u : User | u not in u.suggested and all sug : u.suggested | sugg not in u.suggested and sugg in u.follows.follows
-- div,1
...
-- div,1
all u1,u2-u1,u3-u1-u2:User | u3 in u1.suggested and u2 in u1.follows and u3 in u2.follows implies u3 not in u1.follows
-- div,1
...
-- div,2
all u1, u2, u3 : Users | (u1->u2 in follows and u2->u3 in follows and u1->u3 not in follows)
<=> (u1->u3 in suggested)
-- div,1
all u1,u2,u3 : User-u1 | (not (u3 in u1.follows) and u3 in u2.follows and u2 in u1.follows) implies u3 in u1.suggested
-- div,1
all u1, u2, u3 : Users | u1 -> u2 in follows and u2 -> u3 follows and u1 -> u3 not in follows => u1 -> u3 in suggested
-- div,1
all u, i : User | i in u.suggested implies some o : User | o in u.follows and i in o.follows and i!=o and u!=i and U!=o
-- div,1
all u : Users | all u_followed : follows.u | all sugg : follows.u_followed | sug not in follows.u => sug in u.suggested
-- div,1
no suggested & iden
disj u1 : User, u2 : u1.follows, u3 : u2.follows |  (u3 not in u1.follows) iff (u3 in u1.suggested)
-- div,1
...
-- div,1
all u1, u2, u3 : User | u2 in u1.followers and u3 in u2.followers and u3 not in u1.followers implies u3 in u1.suggested
-- div,1
all x,z : User | x->z in suggested iff(x!=z and x->z not in follows and some y:User| x->y in follows and y->z in follows
-- div,1
all distinct u1, u2, u3: User | u3 in u1.suggested and u2 in u1.follows and u3 in u2.follows implies u3 not in u1.follows
-- div,1
...
-- div,1
all u1, u2 : User | (u1!=u2 and u1 in u2.follows.follows) implies (u1 in u2.suggested and u1!=u2 and u1 not in u2.followed)
-- div,1
all x,y : User | y in x.suggested implies x != y and (x not in follows.y) some z : User | y in z.follows and x in follows.z
-- div,1
all u1,u2,u3 : User | u3 in u1.suggested && u1 != u3 && implies u3 in u2.follows && u2 in u1.follows && u3 not in u1.follows
-- div,1
all u1: User, u2: User, u3: User | u3 in u1.suggested and u2 in u1.follows and u3 in u2.follows implies u3 not in i1.follows
-- div,1
all disj u1,u2: User | u2 in u1.follows.follows && u2 not in u1.follows => u.suggested = ((u.follows).(follows)) - u.follows
-- div,1
all u1, u3 : User | some u2 | u1->u3 in suggested implies (u1->u2 in follows and u2->u3 in follows and u1->u3 not in follows)
-- div,1
...
-- div,5
all u1 : User | all u2 : User-u1 | u2 in u1.suggested implies (u2 not in u1.follows and u2 in u1.follows.follows and u2 not u1)
-- div,1
all u1, u2 : User | u2 in u1.suggested => u2 in u1.follows.follows and u2 not in u1 and u2 not in u1.follows
-- div,1
...
-- div,1
all u1: User, u2: User-u1, u3: User-u3 | u3 in u1.suggested and u2 in u1.follows and u3 in u2.follows implies u3 not in u1.follows
-- div,1
...
-- div,1
all x: User | x not in x.sugegested all x, z: User | x!=z and z in x.suggested implies z not in x.follows and z in x.follows.follows
-- div,1
...
-- div,1
all u:User, u2:User | u2 in u.suggested iff ((some u3:User | u3 in u.follows && u2 in u3.follows) && u!=u2 && u2 is not in u.follows)
-- div,1
all u:User, u2:User | u2 in u.suggested iff ( (some u3:User | u3 in u.follows && u2 in u3.follows) && u3!=u2 && u2 is not in u.follows)
-- div,1
all u,y: User | y in u.suggested implies  (u != y and ( y not in u.follows) and (some z : User | (y in z.follows) and (z in u.follows))
-- div,1
all u,y: User | y in u.suggested implies  (u != y and
( y not in u.follows) and
(some z : User | (y in z.follows) and (z in u.follows))
-- div,1
all u1, u2 : User | u2 in u1.follows implies u2 not in u1.suggested | u2 in u1.suggested implies (u2 in u1.follows.follows and u2 != u1)
-- div,1
...
-- div,1
all u1:User, u2:User | u1 -> u2 in suggested implies (some u3:User | u1 -> u3 in follows and u3 -> u2 in follows and u1 -> not in follows)
-- div,1
all u, i : User | i in u.suggested i not in u.follows  implies some o : User | o in u.follows and i in o.follows and i!=o and u!=i and u!=o
-- div,1
all u1, u3:User | u1->u3 in suggested => some u2:User | u2!=u1 u1!=u3 and u1->u2 in follows and u2->u3 in follows and u1->u3 not in follows
-- div,1
all u1, u3 : User | (u3 in u1.suggested) iff
(u3 not in u1.followsand u1 != u3) and (some u2: User | u2 in  u1.follows and u3 in u2.follows)
-- div,1
...
-- div,1
all user, suggest : univ | user in User and suggest in User and user->suggest in suggested implies some followed : followed->suggest in follows
-- div,2
...
-- div,2
all user : User | user in User.suggested implies (user in User.follows.follows and user not in user.suggested and user.sugested not in user.follows)
-- div,1
...
all a user
-- div,1
all u1, u3 | some u2 : User | (u1 -> u2 in follows and u2 -> u3 in follows and not u1 -> u3 in follows and u1 != u2 and u2 != u3) <=> u1 -> u3 in suggested
-- div,1
...
-- div,1
all u1, u3 : User | some u2 | (u1->u2 in follows && u2->u3 in follows && not u1->u3 in follows && u1 != u2 && u2 != u3 && u1 != u3) <=> (u1->u3 in suggested)
-- div,1
all u:User | u not in u.suggested
all i: Influencer, u: User |i not in u.suggested
forall i: Influencer | i.suggested = {}
...
-- div,1
all u,x,y : User | u -> x in follows and x -> y in follows and u != x and u != y and x != y and u -> y and y-> x not in follows and not in follows iff u -> y in suggested
-- div,1
all u1:User-Influecer , u2:User-(u1+Influecer) , u3:User-(u1+u2+Influecer) | u1->u3 in suggested implies u1->u2 in follows and u2->u3 in follows and u1->u3 not in follows
-- div,1
...
all u1, u2, u3: User | u1 != u2 and u1!=u3 and au1->u2 in follows and u2->u3 in follows and u1->u3 not in follows <=> u1->u3 in suggested
-- div,1
all u1, u2, u3:User | u1->u3 in suggested iff u1->u2 in follows and u2->u3 in follows and u1->u3 not in follows
all u:User | u->u not in suggested and u2!=u1 and u1!=u3 and
-- div,1
...
-- div,1
all u1,u2 : User | (u1 in u2.suggested implies (u1 in ( u2.follows.follows - u2.follows) and u1!=u2)) and  ( (u1 in ( u2.follows.follows - u2.follows) implies (u1 in u2.suggested)
-- div,1
all u1,u2 : User | (u1 in u2.suggested implies (u1 in ( u2.follows.follows - u2.follows) and u1!=u2)) and  ( (u1 in ( u2.follows.follows - u2.follows) implies (u1 in u2.suggested))
-- div,1
...
all u : User | s != u and s in f.follows and s not in u.follows => s in u.suggested
-- div,1
all u:User | some s: u.suggested | s in u.follows.follows and s!=u
...
all u: User | u not in u.suggested
-- div,2
all u1,u2 : User | (u2 in u1.suggested implies (u1 != u2 and u2 not in u1.follows and u2 in u1.follows.follows)) and ((u1 != u2 and u2 not in u1.follows and u2 in u1.follows.follows) imlpies u2 in u1.suggested)
-- div,2
...
all user1, user2, user3 : User | user1 != user2 != user and ((user3 not in user1.follows) and (user3 in user2.follows) and (user2 in user1.follows)) implies user3 in user1.suggested
-- div,1
...
all u : User | all i : Influencer |
-- div,2
all u1, u2 : User | u2 in u1.suggested implies u2 not in (u1.follows)+u1
all u1, u2 : User | u2 in u1.suggested implies u2 in u1.follows.follows1
all u1,u2 : User | u2 in u1.suggested <=> u2 not in u1.follows and u2!=u1 and u2 in u1.follows.follows
-- div,1
all disj x, y, z: User | x->y in follows and y->z in follows and x->z not in follows implies x->z in suggested
...
all u6 : User | (none u6.follows) implies (none u6.suggested)
-- div,3
all u1, u2, u3 : User | ((u1 in follows.u2) && (u2 in follows.u3)) implies (u3 in suggested.u1)
all u : User | u not in suggested.u
all u4, u5 : User | (u4 in follows.u5) implies (u4 not in suggested.u5)
all u6 : User | (none u6.follows) implies (none suggested.u6)
-- div,2
all u1, u2, u3 : User | ((u1 in follows.u2) && (u2 in follows.u3)) implies (u3 in suggested.u1)
all u : User | u not in suggested.u
all u4, u5 : User | (u4 in follows.u5) implies (u4 not in suggested.u5)
...
all u : User | u not in suggested.u
all u4, u5 : User | (u4 in follows.u5) implies (u4 not in suggested.u5)
all u6 : User | (none u6.follows) implies (none u6.suggested none)
-- div,1
