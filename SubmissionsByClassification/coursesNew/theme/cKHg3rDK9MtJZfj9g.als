...
pred inv9 {
	...
	all p : Professor | (all col : Professor - p | some (col.teaches & p.teaches) => no (col.enrolled & p.teaches))
...
pred inv11 {
    ...
    all s : Student | (all c : Course, g : Grade | s->g in c.grades => c in s.enrolled)
